 ...
 */
   ...
   */
  #define WATCH_TEMP_PERIOD 0.5                // Seconds
 ...
 */
  ...
  //#define PID_ADD_EXTRUSION_RATE
    ...
    #define DEFAULT_Kc (150) //heating power=Kc*(e_speed)
    #define LPQ_MAX_LEN 100
  #endif
#endif
...
#define TEMP_SENSOR_AD595_GAIN   3.0
...
#define X_HOME_BUMP_MM 0.8
#define Y_HOME_BUMP_MM 0.8
#define Z_HOME_BUMP_MM 0.8
#define HOMING_BUMP_DIVISOR {10, 10, 15}  // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
#define DEFAULT_MINSEGMENTTIME        5000
...
// Not working O
//#define XY_FREQUENCY_LIMIT  25

// Minimum planner junction speed. Sets the default minimum speed the planner plans for at the end
// of the buffer and all stops. This should not be much greater than zero and should only be changed
// if unwanted behavior is observed on a user's machine when running at very slow speeds.
#define MINIMUM_PLANNER_SPEED 0// (mm/sec)

// Microstep setting (Only functional when stepper driver microstep pins are connected to MCU.
#define MICROSTEP_MODES {16,16,16,16,16} // [1,2,4,8,16]

// Motor Current setting (Only functional when motor driver current ref pins are connected to a digital trimpot on supported boards)
#define DIGIPOT_MOTOR_CURRENT {255,255,255,255,255} // Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
...
#define MM_PER_ARC_SEGMENT 0.8
#define N_ARC_CORRECTION 20

const unsigned int dropsegments = 3;  //everything with less than this number of steps will be ignored as move and joined with the next movement
...
// Add support for experimental filament exchange support M600; requires display
  ...
  #define FILAMENTCHANGEENABLE
    ...
    #define FILAMENTCHANGE_FINALRETRACT -535
    #define AUTO_FILAMENT_CHANGE                //This extrude filament until you press the button on LCD
    #define AUTO_FILAMENT_CHANGE_LENGTH 0.04    //Extrusion length on automatic extrusion loop
    #define AUTO_FILAMENT_CHANGE_FEEDRATE 8000   //Extrusion feedrate (mm/min) on automatic extrusion loop    
  #endif
#endif
