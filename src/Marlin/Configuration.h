...
#define PID_MAX 255 // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  //#define PID_OPENLOOP PID_MAX  // Puts PID in open loop. M104/M140 sets the output power from 0 to PID_MAX
  ...
  #define K1 0.9 //smoothing factor within the PID

  #define  DEFAULT_Kp 108.86
  #define  DEFAULT_Ki 6.03
  #define  DEFAULT_Kd 30.85
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 127.00
  #define  DEFAULT_bedKi 1.023
  #define  DEFAULT_bedKd 505.4
...
#define EXTRUDE_MAXLENGTH (X_MAX_LENGTH+Y_MAX_LENGTH) + 600 //prevent extrusion of very large distances.
...
// @section homing
#define MIN_Z_HEIGHT_FOR_HOMING 0 // (in mm) Minimal z height before homing (G28) for Z clearance above the bed, clamps, ...
...
//#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define AUTO_BED_LEVELING_GRID
    ...
    #define MIN_PROBE_EDGE 3 // The Z probe minimum square sides can be no smaller than this.
  ...
  #define Z_PROBE_END_SCRIPT "G1 X95 Y10 F3000" // These commands will be executed in the end of G29 routine.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,207} 
#define DEFAULT_MAX_FEEDRATE          {90, 90, 10, 100} 
#define DEFAULT_MAX_ACCELERATION      {2000,2000, 25,15000} 
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,800,207} 
#define DEFAULT_MAX_FEEDRATE          {200, 200, 15, 150} 
#define DEFAULT_MAX_ACCELERATION      {3000,3000,40,15000} 
...
#define CUSTOM_M_CODES
    ...
    #define Z_PROBE_OFFSET_RANGE_MAX -(Z_PROBE_OFFSET_RANGE_MIN)
  #endif
#endif
...
#define SERVO_ENDSTOP_ANGLES {{0,0}, {0,0}, {170,30}}
...
#define DEACTIVATE_SERVOS_AFTER_MOVE
  ...
  #define SERVO_DEACTIVATION_DELAY 400
#endif
