 ...
 */
 ...
 #define EXTRUDE_MINTEMP 160
  ...
  // https://bitbucket.org/fmalpartida/new-liquidcrystal/wiki/schematics#!shiftregister-connection
    ...
    #define LCD_STR_FOLDER      "\x00"
    #define LCD_STR_ARROW_RIGHT "\x01"
    #define LCD_STR_UPLEVEL     "\x02"
    #define LCD_STR_CLOCK       "\x03"
    #define LCD_STR_FEEDRATE    "\x04"
    #define LCD_STR_BEDTEMP     "\x05"
    #define LCD_STR_THERMOMETER "\x06"
    #define LCD_STR_DEGREE      "\x17"
    #define LCD_STR_SD          "\x08"

    #define LCD_STR_SPECIAL_MAX '\x10'
    ...
    #define LCD_STR_SD          "\x01"
    #define LCD_STR_DEGREE      "\x02"
    #define LCD_STR_THERMOMETER "\x03"
  ...
  #ifdef TMC2100 
    #define MAX_STEP_FREQUENCY 4000
  #else
